...
export const assignments = [
    ...
    {"name": "Project Status Presentions", "description": "Current state of the project, biggest remaining challenges, and a high-level overview of system architecture."},
